...
def predict_endpoint():
    ...
    #received_wind_speed_avg = 10
    received_data_df['Ws1_avg']=received_wind_speed_avg
    prepared_df = prepare_features(received_data_df, training_mode=False)
    df_prediction = predict(prepared_df, "/home/jovyan/Formation-MLOps-2-2/exposition/model_as_a_service/20200616-140746.joblib")
    prediction = df_prediction["predictions"].values[0]
